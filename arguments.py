...
def get_args():
    ...
    parser.add_argument('--algo', default='dqn', help='algorithm to use: dqn | double')
    ...
    parser.add_argument('--replay_threshold', type=int, default=10000, help='min number of entries in replay buffer for training to start. For non-atari, set it to be batch size')
    ...
    parser.add_argument('--env_type', default='atari', help='gym or atari (default: atari)')
    parser.add_argument('--FA', default='deep', help='linear or deep when environment is gym. If Atari, CNN is chosen automatically (default: deep)')
    ...
    parser.add_argument('--log_dir', default='/scratch/ravitej3/temporal/', help='directory to save agent logs (default: /tmp/gym)')
