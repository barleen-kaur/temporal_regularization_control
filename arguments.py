...
def get_args():
    ...
    parser.add_argument('--plot_idx', type=int, default=250, help='frequency with which to plot the graph')
    ...
    parser.add_argument('--lamb', type=float, default=0.1, help='lambda value(default: 0.2)')
