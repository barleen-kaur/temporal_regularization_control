...
def get_args():
    ...
    parser.add_argument('--replay_threshold', type=int, default=10000, help='min number of entries in replay buffer for training to start. For non-atari, set it to be batch size (default: 10000)')
